...
export default function WorkspacePage() {
  ...
  if (loading) return <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-amber-900/90 via-amber-800/80 to-stone-800 text-amber-200 text-xl animate-pulse">Loading workspace...</div>;
  if (error) return <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-amber-900/90 via-amber-800/80 to-stone-800 text-white p-8 text-center"><p className="text-red-400 text-xl">{error}</p></div>;
    ...
    <div className="relative min-h-screen overflow-hidden bg-gradient-to-br from-amber-900/90 via-amber-800/80 to-stone-800 py-12">
      ...
      <div className="relative z-10 container mx-auto px-6 py-12 max-w-4xl">
        ...
        <div className="bg-white/90 backdrop-blur-sm rounded-2xl shadow-2xl p-6 md:p-8 space-y-6 border border-white/20">
          ...
          {data.client_name && <p className="text-gray-700 font-medium">Client: {data.client_name}</p>}
          {isActive ? (
